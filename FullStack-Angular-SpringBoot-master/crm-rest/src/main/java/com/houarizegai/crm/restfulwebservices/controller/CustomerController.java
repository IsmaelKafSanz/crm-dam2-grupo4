...
public class CustomerController {
    ...
    public ResponseEntity<Void> createCustomer(@PathVariable String username, @RequestBody Customer customer) {
        System.out.println("=== CREATE CUSTOMER (POST) ===");
        System.out.println("Received customer: " + customer);
        
        // IMPORTANTE: Asegurarse de que el ID sea null para que Hibernate lo trate como nuevo
        customer.setId(null);
        
        System.out.println("Customer after setting id to null: " + customer);
